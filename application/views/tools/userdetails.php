		...
		<div class="container-fluid">
			...
			<div class="row">	
				<div class="col col-sm-12 col-md-12 col-lg-12">	
					...
					<div class="card card-primary">
						<div class="card-header with-border">
						  <h3 class="card-title">User Machine Access</h3>
						  <div class="card-tools">
							<?php
								if ($accessmenu['toolsuseracounts']['isedit']=='T')			
								{
									echo form_submit('btnSaveMachineAccess','Save','class="btn btn-success buttonclick"');
								}
							?>
						  </div>
						</div>
											...
											<?php
												if ($cookiesPending){
													foreach($cookiesPending as $row){
														...
														echo '<a href="'.base_url().'tools/userdetails/cookie/1/'.$param1.'/'.$row['usercookieid'].'" class="btn btn-success btn-xs mb-1">Approve</a>';
														echo '<a href="'.base_url().'tools/userdetails/cookie/0/'.$param1.'/'.$row['usercookieid'].'" class="btn btn-danger btn-xs">Deny</a>';
														echo '</td>';
														echo '</tr>';
													}
												}
											...
											<?php
												...
												if ($cookiesOthers){
													foreach($cookiesOthers as $row){
														...
														echo $row['status'];
														if ($row['status']=='Unathorize' && $ctr==0){
															echo '<a href="'.base_url().'tools/userdetails/cookie/2/'.$param1.'/'.$row['usercookieid'].'" class="btn btn-primary btn-xs">Set as Expired</a>';
														}
														echo '</td>';
														echo '</tr>';
														$ctr =1;
