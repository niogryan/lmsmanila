					...
					<div class="card">
											...
											foreach($list as $row)
											{
												...
												// {
													...
													// {
														...
														// $advancepayment_asofyesterday -=$row['advancepayment'];
													// }
												// }
												...
												if ($is_advanced_fully_paid==false)
												{
													...
													if ($this->session->userdata('role')=='Administrator')
													{
														echo '<td style="text-align:center;">'.anchor('loan/details/'.$row['loanid'].'/'.$this->mylibraries->encrypt('v'.$row['loanid']),$row['referencenumber'],'target="_BLANK"').'</td>';
												...
												if ($this->session->userdata('role')=='Administrator')
												{
													echo '<td style="text-align:right; font-weight:bold;">'.$this->mylibraries->replaceszerotoblank($totalprincipal).'</td>';
													echo '<td style="text-align:right; font-weight:bold;">'.$this->mylibraries->replaceszerotoblank($totalinterest).'</td>';
												}
												
												echo '<td style="text-align:right;  font-weight:bold;">'.$this->mylibraries->replaceszerotoblank($totaldues).'</td>';
												echo '<td style="text-align:right;  font-weight:bold;">'.$this->mylibraries->replaceszerotoblank($total_daily_absent).'</td>';
												echo '<td style="text-align:right;  font-weight:bold;">'.$this->mylibraries->replaceszerotoblank($total_buho_payments).'</td>';
												echo '<td style="text-align:right;  font-weight:bold;">'.$this->mylibraries->replaceszerotoblank($total_dailyabsentbalance_asofyesterday).'</td>';
												echo '<td style="text-align:right;  font-weight:bold;">'.$this->mylibraries->replaceszerotoblank($total_advancepayment_asofyesterday).'</td>';
												echo '<td style="text-align:right;  font-weight:bold;">'.$this->mylibraries->replaceszerotoblank($total_balanceadvancededuction ).'</td>';
												echo '<td style="text-align:right;  font-weight:bold;">'.$this->mylibraries->replaceszerotoblank($total_new_advance_payments).'</td>';
												echo '<td style="text-align:right;  font-weight:bold;">'.$this->mylibraries->replaceszerotoblank(0).'</td>';
												echo '<td style="text-align:right;  font-weight:bold;">'.$this->mylibraries->replaceszerotoblank(0).'</td>';
												...
												if ($newloan)
												{
													...
													if ($this->session->userdata('role')=='Administrator')
													{
														echo '<td style="text-align:center; font-weight:bold;" colspan="15">- - - - - - - - - - New Loan with Advance Payment - - - - - - - - - -</td>';
													}
													else
													{
														echo '<td style="text-align:center; font-weight:bold;" colspan="13">- - - - - - - - - - New Loan with Advance Payment - - - - - - - - - -</td>';
													}
													echo '</tr>';
													...
													foreach($newloan as $row)
													{
														...
														echo '<td style="text-align:right;"></td>';
														echo '<td style="text-align:right;">'.$this->mylibraries->replaceszerotoblank(0).'</td>';
														echo '<td style="text-align:center;" class="'.($this->session->userdata('selecteddate')>=$row['duedate'] ? 'text-red text-bold' : null).'">'.($row['duedate']!='0000-00-00' ? date("Y-m-d", strtotime($row['duedate'])) : '&nbsp;').'</td>';
														echo '</tr>';
														$ctr++;
						...
						<table class="table table-bordered table-striped">
							...
							if ($badaccountwithpayments)
							{
									...
									if ($this->session->userdata('role')=='Administrator')
									{
										echo '<td style="text-align:right;  font-weight:bold;">'.$this->mylibraries->replaceszerotoblank($totalprincipal_bad).'</td>';
										echo '<td style="text-align:right;  font-weight:bold;">'.$this->mylibraries->replaceszerotoblank($totalinterest_bad).'</td>';
									}
						...
						<div class="row">
							<div class="col-sm-12 col-md-6 col-lg-6">
								<table class="table table-bordered table-striped table1" id="">
										<thead>                  
											<tr>
												<th style="text-align:center; width:80px;" valign="middle">#</th>
												<th style="text-align:center;" valign="middle">Customer Name</th>
												<th style="text-align:center; width:120px;">Loan No.</th>
									...
									<?php
											...
											foreach($newbad as $row)
											{
												...
												$overallpaymentsasofyesterday=$CI->report_model->gettotalpaymentsasbydate($row['loanid'],$this->session->userdata('selecteddate'));
											...
											<table class="table table-bordered table-striped table1" id="">
													<thead>                  
														<tr>
															...
															<th style="text-align:center;" valign="middle">Customer Name</th>
															<th style="text-align:center; width:120px;">Loan No.</th>
															<th style="text-align:center; width:120px;">Advance Payment</th>
															<th style="text-align:center; width:120px;">Due Date</th>
														</tr>
											...
											<?php
													...
													foreach($newloan as $row)
													{
														if($row['advancepayment']>0)
														{
															...
															echo '</tr>';
															$ctr++;
															$totalnewloanadvancepayment +=$row['advancepayment'];
														}
													}
