...
<html lang="en-ph">
	...
	<body>
		<div style="width:100%; text-align:center; margin-top:-20px;">
			...
			<p style="font-size:12pt; margin-top:-10px;">Passbook Charge Report</p>
							...
							<?php
								if ($list)
								{
									...
									foreach($list as $row)
									{
										...
										echo '<td style="text-align:center;">'.($row['releaseddate']!='0000-00-00' ? date("Y-m-d", strtotime($row['releaseddate'])) : '&nbsp;').'</td>';
