	<?php
		...
		echo form_open('rpt/servicecharge/',$attributes);
	?>
						...
						<div class="card-header">
							...
							<div class="card-tools">
								<?php 
									if ($list)
									{
										echo anchor('rptprint/servicecharge/'.$this->session->userdata('selectedbranch').'/'.$this->session->userdata('selectedarea').'/'.$this->session->userdata('selectedfrom').'/'.$this->session->userdata('selectedto'),'Print','class="btn btn-success ml-1" target="_BLANK"');
									}
								?>
							</div>
						</div>
